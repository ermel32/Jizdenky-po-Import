...
class CDTakeoutImporter {
  ...
  saveActiveTickets(active, cancellations) {
    ...
    // ČD jízdenky, které už mají v novém exportu storno, z aktuálního
    // kalendáře odstraníme. Ručně přidaných vlaků se to vůbec nedotkne.
    ...
    // Odstraň i případné staré override záznamy, které by zůstaly po starší verzi importeru.
    ...
    for (const ticket of active) {
      ...
      if (existing) {
        ...
        this.app.data.tickets.push({ id: uid("ticket"), ...ticket, source: "cd-takeout" });
        addedCount++;
      }
    }
